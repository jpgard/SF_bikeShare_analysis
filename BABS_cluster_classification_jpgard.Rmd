...
par(mfrow=c(1,1))
heatmap.2(tripdata_knn, hclustfun = function(x) hclust(x, method = "complete"), col=redblue(256), scale='row', trace = "none", density.info="density", cexCol = 0.5, labRow = "", main = "Cluster Heatmap With Complete Linkage and Euclidean Distance")
```
